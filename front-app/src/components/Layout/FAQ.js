  ...
  return (
    <Fragment>
      <div className="container">
        <h4 className="profile-user">Часто задаваемые вопросы</h4>
            ...
            <Card>
              ...
              <Accordion.Collapse eventKey="0">
                <Card.Body className="text-justify">
                  ...
                  пользователя. Чтобы поставит свой, вам необходимо перейти на
                  веб сайт:{" "}
            ...
            <Card>
              ...
              <Accordion.Collapse eventKey="2">
                <Card.Body className="text-justify">
                  ...
                  <br /> Однако, с увереностью можно сказать, что это состоится
                  в отсносительно недалёкий промежуток времени.
                </Card.Body>
              </Accordion.Collapse>
            </Card>
            ...
            <Card>
              ...
              <Accordion.Collapse eventKey="3">
                <Card.Body className="text-justify">
                  ...
                  можете развернуть у себя. Совсем скоро там появится
                  документация по работе над данным проектом.
                  <br />
                  <br />
